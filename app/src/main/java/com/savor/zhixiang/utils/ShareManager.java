...
import com.savor.zhixiang.widget.WebDialog;
...
public class ShareManager {
    ...
    public void share(final Activity activity, final String text, final String title, final String image, final String targeturl) {
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        if(share_media == SHARE_MEDIA.SINA) {
                            UMImage umImage = new UMImage(activity,R.mipmap.ico_drawer);
    ...
    public void share(final Activity activity, final String text, final String title, final String image, final String targeturl, final ShareBoardlistener shareBoardlistener) {
        ShareBoardConfig config = new ShareBoardConfig();
        config.setMenuItemBackgroundShape(ShareBoardConfig.BG_SHAPE_NONE);
        config.setShareboardBackgroundColor(activity.getResources().getColor(R.color.color_share_bg));
        config.setCancelButtonBackground(activity.getResources().getColor(R.color.color_share_cl_bg));
