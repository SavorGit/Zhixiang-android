...
public class FlowLayout extends ViewGroup {
    ...
    private static final int ANIM_FADE_UP = 0x1;
    private static final int ANIM_DISABLE = 0x0;
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAnimMode = ta.getInt(R.styleable.TagFlowLayout_animMode, ANIM_DISABLE);
        ta.recycle();
    }
